...
def init_module():
  ...
  est = FoundationPose(model_pts=mesh_tmp.vertices.copy(), model_normals=mesh_tmp.vertex_normals.copy(), mesh=mesh_tmp, scorer=None, refiner=None, glctx=glctx, debug_dir=debug_dir, debug=debug)
...
def process(handle, mesh_file, scene_dir, est_refine_iter, track_refine_iter, debug, debug_dir):
